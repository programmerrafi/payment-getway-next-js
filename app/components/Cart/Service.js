...
function Service({ item }) {
  return (
    <div className="group w-[45%] h-[100px] sm:w-[190px] sm:h-[105px] lg:h-auto lg:w-[356px] border border-white [&:nth-child(1)]:shadow-3xl hover:shadow-3xl rounded-lg px-10 lg:mb-12 duration-300 ease-out hover:-translate-y-2">
      <div className="">
        ...
        <h1 className="pb-8 font-RadHatText font-medium text-base text-colorSecondary">
          {item.text}
        </h1>
      </div>
    </div>
